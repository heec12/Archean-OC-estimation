...
#   julia --threads 4 5H2O_test_parallel.jl
#
...
const SCRATCH_DIR = "/storage/home/hcoda1/7/hchoi342/scratch/Archean-OC-estimation/perplex_ensemble/$VERSION"
...
#                     n_ok += 1
    ...
    write_lookup_table(h2o_mean, joinpath(OUTPUT_DIR, "$(VERSION)_h2o_bound_mean_$(scenario).csv"))
    write_lookup_table(h2o_std,  joinpath(OUTPUT_DIR, "$(VERSION)_h2o_bound_std_$(scenario).csv"))
    ...
    write_lookup_table(h2o_p05,  joinpath(OUTPUT_DIR, "$(VERSION)_h2o_p05_$(scenario).csv"))
    write_lookup_table(h2o_p50,  joinpath(OUTPUT_DIR, "$(VERSION)_h2o_p50_$(scenario).csv"))
    write_lookup_table(h2o_p95,  joinpath(OUTPUT_DIR, "$(VERSION)_h2o_p95_$(scenario).csv"))
